...
# 1. CONFIGURATION
# ==========================================
APP_NAME = "sinhala-base-training"
...
REMOTE_OUTPUT_DIR = "/data/sinhala-base-final"
...
def train():
    ...
    # D. FORMATTING FUNCTION (Standard Alpaca)
...
def main():
    ...
    print("🚀 Triggering Base Model Training Job...")
    train.remote()