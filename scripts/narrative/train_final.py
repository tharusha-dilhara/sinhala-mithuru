...
# 1. CONFIGURATION
# ==========================================
APP_NAME = "sinhala-multitask-train-v1" 
...
# Where the final multi-task model will be saved
REMOTE_OUTPUT_DIR = "/data/sinhala-multitask-model-v1"
...
def train():
    ...
    print(" Starting Llama-3 Multi-Task Training (3 Epochs)...")
    ...
    # SANITY CHECK: Print the first formatted example to ensure prompts look correct
    print("\n" + "="*50)
    print(" CHECKING FIRST TRAINING ROW FORMAT:")
    ...
    print(f"Saving Standard LoRA Adapters to {REMOTE_OUTPUT_DIR}...")
    model.save_pretrained(REMOTE_OUTPUT_DIR)
    tokenizer.save_pretrained(REMOTE_OUTPUT_DIR)
    
    volume.commit()
    print("Training, Merging, and Exporting Finished Successfully!")
