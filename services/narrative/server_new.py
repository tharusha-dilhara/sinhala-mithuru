...
# 1. CONFIGURATION
# ==========================================
APP_NAME = "sinhala-mithuru-backend-v11-5epochs"
VOL_NAME = "sinhala-model-storage"

# Pointing to your NEW 5-Epoch weights!
ADAPTER_DIR = "/data/outputs_ihalage_5_epochs_lora" 
...
class StoryEngine:
    ...
    def load_model(self):
        ...
        print(f"🚀 Loading vLLM Engine: {BASE_MODEL} + 5-EPOCH Adapters: {ADAPTER_DIR}...")
        ...
        print("✅ 5-EPOCH Model ready for BLITZ-SPEED Inference (vLLM Acceleration).")
    ...
    def generate_quiz_text(self, story_text: str, level: str):
        ...
        try:
            ...
            for q in raw_quizzes:
                ...
                # Use random safely inside Modal containers
                random_instance = random.Random()
                random_instance.shuffle(options)
...
# 3. FASTAPI ENDPOINT
# ==========================================
web_app = FastAPI(title="Sinhala Mithuru Backend V11 (5-EPOCH vLLM Accelerated)")
